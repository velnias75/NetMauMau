...
#ifndef NETMAUMAU_CONNECTIONREJECTEDEXCEPTION_H
#define NETMAUMAU_CONNECTIONREJECTEDEXCEPTION_H
...
/**
 * @ingroup exceptions
 * @brief The connection to the server got rejected
 * @since 0.4
 */
class _EXPORT ConnectionRejectedException : public Common::Exception::SocketException {
...
#endif /* NETMAUMAU_CONNECTIONREJECTEDEXCEPTION_H */
